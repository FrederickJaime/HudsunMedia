	...
	for (var i = 0; i < ie11Styles.length; i++) {
	 ...
	 if(brwoser == "ie10" || brwoser == "ie11" ){
		...
		$('.grayscale img').each(function(){
			...
			el.css({"position":"absolute"}).wrap("<div class='img_wrapper' style='display: inline-block'>").clone().addClass('img_grayscale ieImage').css({"position":"absolute","opacity":"0"}).insertBefore(el).queue(function(){
